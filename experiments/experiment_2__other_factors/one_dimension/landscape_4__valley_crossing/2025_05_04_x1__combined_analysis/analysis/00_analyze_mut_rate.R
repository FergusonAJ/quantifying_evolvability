...
df_base = read.csv('../../2025_05_04_40__base/data/pairwise_data.csv')
...
df_mut_very_high = read.csv('../../2025_05_04_44__mut_0_01/data/pairwise_data.csv')
...
df_combined$y =  0.85 - df_combined$condition_num * 0.05
