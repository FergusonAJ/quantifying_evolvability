...
df_10 = read.csv('../../2025_05_04_45__pop_10/data/pairwise_data.csv')
df_10$mut_prob = 0.001
df_10$pop_size = 10
df_10$condition_num = 1

df_100 = read.csv('../../2025_05_04_46__pop_100/data/pairwise_data.csv')
df_100$mut_prob = 0.001
df_100$pop_size = 100
df_100$condition_num = 2

df_10k = read.csv('../../2025_05_04_47__pop_10000/data/pairwise_data.csv')
