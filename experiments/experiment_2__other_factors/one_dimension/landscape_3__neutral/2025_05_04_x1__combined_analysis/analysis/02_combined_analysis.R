...
ggp_mut = ggplot(df_combined[mut_mask,]) + 
  ...
  scale_y_continuous(limits = c(0.7, 1.8), breaks = c(1, 1.25, 1.5, 1.75), minor_breaks = c(1, 1.125, 1.25, 1.375, 1.5, 1.625, 1.75)) + 
...
ggsave(paste0(plot_dir, '/combined_summary_plot.pdf'), units = 'in', width = 12, height = 5)
ggsave(paste0(plot_dir, '/combined_summary_plot.png'), units = 'in', width = 12, height = 5)
